...
namespace DotRecast.Recast.Toolset.Geom
{
    public class DemoInputGeomProvider : IInputGeomProvider
    {
        ...
        public DemoInputGeomProvider(float[] vertices, int[] faces)
        {
            ...
            {
                bmin = Vector3.Min(bmin, vertices.ToVec3(i * 3));
                bmax = Vector3.Max(bmax, vertices.ToVec3(i * 3));
            }
        ...
        public void CalculateNormals()
        {
            ...
            {
                Vector3 v0 = vertices.ToVec3(faces[i] * 3);
                Vector3 v1 = vertices.ToVec3(faces[i + 1] * 3);
                Vector3 v2 = vertices.ToVec3(faces[i + 2] * 3);
                Vector3 e0 = v1 - v0;
                Vector3 e1 = v2 - v0;
