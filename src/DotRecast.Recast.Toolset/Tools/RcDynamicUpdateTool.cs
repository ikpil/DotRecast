...
namespace DotRecast.Recast.Toolset.Tools
{
    public class RcDynamicUpdateTool : IRcToolable
    {
        ...
        public RcGizmo CompositeCollider(Vector3 p, float walkableClimb)
        {
            ...
            var rx = Matrix4x4.CreateFromAxisAngle(forward, float.DegreesToRadians(45));
        ...
        {
            var rx = Matrix4x4.CreateFromAxisAngle(Vector3.UnitX, float.DegreesToRadians((float)random.NextDouble() * ax));
            var ry = Matrix4x4.CreateFromAxisAngle(Vector3.UnitY, float.DegreesToRadians((float)random.NextDouble() * 360));
            //var m = Matrix4x4.Multiply(rx, ry);
            var m = Matrix4x4.Multiply(ry, rx);
        ...
        private static Vector3 MulMatrixVector(ref Vector3 resultvector, Matrix4x4 matrix, Vector3 pvector)
        {
