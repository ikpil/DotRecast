...
namespace DotRecast.Recast
{
    ...
    public static class RcRasterizations
    {
            ...
            int flagMergeThreshold)
        {
            ...
            Vector3 triBBMin = verts.ToVec3(v0 * 3);
            triBBMin = Vector3.Min(triBBMin, verts.ToVec3(v1 * 3));
            triBBMin = Vector3.Min(triBBMin, verts.ToVec3(v2 * 3));

            Vector3 triBBMax = verts.ToVec3(v0 * 3);
            triBBMax = Vector3.Max(triBBMax, verts.ToVec3(v1 * 3));
            triBBMax = Vector3.Max(triBBMax, verts.ToVec3(v2 * 3));
