...
public static class GizmoRenderer
{
    ...
    public static void RenderTrimesh(RecastDebugDraw debugDraw, RcTrimeshGizmo trimesh)
    {
        ...
        {
            RcVec3f v0 = trimesh.vertices.ToVec3(3 * trimesh.triangles[i]);
            RcVec3f v1 = trimesh.vertices.ToVec3(3 * trimesh.triangles[i + 1]);
            RcVec3f v2 = trimesh.vertices.ToVec3(3 * trimesh.triangles[i + 2]);
